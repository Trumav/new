...
wget -O /usr/bin/addssh https://raw.githubusercontent.com/fromhell26/new/main/adds.sh && chmod +x /usr/bin/addssh
wget -O /usr/bin/addxr https://raw.githubusercontent.com/fromhell26/new/main/addxr.sh && chmod +x /usr/bin/addxr
wget -O /usr/bin/addtrg https://raw.githubusercontent.com/fromhell26/new/main/trjg.sh && chmod +x /usr/bin/addtrg
...
cd /usr/bin
wget -O ban "https://raw.githubusercontent.com/fromhell26/sce/main/kill.sh"
chmod +x ban
cd
